...
var regionMap = map[string][]string{
	...
	"Asia":          {"Bangladesh", "Bhutan", "Cambodia", "Guam", "Hong Kong", "India", "Indonesia", "Israel", "Japan", "Jordan", "Kazakhstan", "Kyrgyzstan", "Laos", "Macao", "Malaysia", "Mongolia", "Northern Mariana Islands", "Oman", "Philippines", "Qatar", "Russia", "Singapore", "South Korea", "Sri Lanka", "Taiwan", "Thailand", "United Arab Emirates", "West Bank"},
